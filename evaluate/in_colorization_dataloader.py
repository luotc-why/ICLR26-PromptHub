...
class DatasetColorization(Dataset):
    def __init__(self, datapath, image_transform, mask_transform, padding: bool = 1,
                 ...
                 reverse_support_and_query: bool = False, random: bool = False, split: str = 'val', meta_split: str = '0', feature_name: str = 'features_vit_val', seed: int = 0, to_device: str = 'cuda:0'):
