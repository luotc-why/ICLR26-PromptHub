...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, vq_ckpt_dir='/data/luotianci/TO_JPSX/VisualICL/weights/vqgan'):
        super().__init__()
...
def mae_vit_small_patch16(vq_ckpt_dir='/data/luotianci/TO_JPSX/VisualICL/weights/vqgan', **kwargs):
...
def mae_vit_base_patch16_dec512d8b(vq_ckpt_dir='/data/luotianci/TO_JPSX/VisualICL/weights/vqgan', **kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_large_patch16_dec512d8b(vq_ckpt_dir='/data/luotianci/TO_JPSX/VisualICL/weights/vqgan', **kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_huge_patch14_dec512d8b(vq_ckpt_dir='/data/luotianci/TO_JPSX/VisualICL/weights/vqgan', **kwargs):
    model = MaskedAutoencoderViT(
